...
//
// 2011 - 2015 by Markus Mandalka - http://www.mandalka.name
//
...
$cfg['facets']=array(
		...
		'organization_ss' => array ('label'=>'Organizations'),
		'person_ss' => array ('label'=>'Persons'),
		'location_ss' => array ('label'=>'Locations'),
...
foreach ($selected_facets as $selected_facet=>$facet_value) {
	...
	*/
	if ($view != 'table' && $view != 'preview') {
		$additionalParameters['fl']='id,content_type,title,container_s,author_s,tags_ss,file_modified_dt,last_modified,file_size_i';
	}
